...
C_SRCS += \
/Users/samuelmpoloka/nanopb/tests/options/options.c 
...
nanopb/tests/options/options.o: /Users/samuelmpoloka/nanopb/tests/options/options.c nanopb/tests/options/subdir.mk
...
clean-nanopb-2f-tests-2f-options:
	-$(RM) ./nanopb/tests/options/options.d ./nanopb/tests/options/options.o ./nanopb/tests/options/options.su
